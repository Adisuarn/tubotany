...
const Home = () => {
  return (
    <main className="w-full h-full">
        ...
        <div className="w-full md:w-[90%] flex p-5 md:grid md:grid-rows-[auto_1fr] gap-4">
          <aside className="w-7/12 md:row-span-1 md:w-full md:flex md:flex-col md:text-center">
            ...
            <p className="mt-2">
              ...
              โดยแต่ละชนิดมีความโดดเด่นและคุณค่าทางธรรมชาติที่แตกต่างกันไป นอกจากนี้ยังมีพรรณไม้ที่มีประโยชน์ในด้านการศึกษา
      ...
      <section
        className="w-full py-8 bg-[#E3CAA5]/30"
      >
        <div className="container mx-auto p-5">
          <h2 className="text-2xl md:text-4xl font-bold mb-6 text-[#AD8B73] text-center md:mb-10">หมวดหมู่พันธุ์ไม้</h2>
          <div>
